...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cta-btn:hover { background: var(--neon-green); color: #000; box-shadow: 0 0 25px var(--neon-green); }
...
export default function App() {
  ...
  const MINT_ADDRESS = "CdczQNrp2DZ9c89LSjCyRF6VmS4VtTCBkNSjXtpvmoon"; // Mets ici ta nouvelle adresse de mint Solana
      ...
      <div className="scanlines">
        ...
        <section className="grid-bg" style={{ minHeight: "85vh", display: "flex", alignItems: "center" }}>
          <div className="container hero-flex" style={{ display: "flex", alignItems: "center", gap: 60 }}>
            <div className="hero-text" style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: "1.2rem", color: "#b0d0bb", margin: "30px 0 35px", maxWidth: 550, lineHeight: 1.6 }}>
            ...
            <div style={{ flex: "0 0 auto" }}>
              <img src={logoFrogstand} className="img-mobile" alt="Frogstand Logo" style={{ width: 380, filter: "drop-shadow(0 0 20px var(--neon-green))" }} />
            </div>
          </div>
        </section>
        ...
        <section id="about" style={{ background: "var(--bg-panel)" }}>
          <div className="container about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
            <div className="corner-cut" style={{ background: "var(--bg-card)", padding: 40, border: "1px solid rgba(57,255,20,0.2)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {["FAIR LAUNCH", "BURNED LP", "100% UNLOCKED", "ZERO TAX"].map(title => (
                <div key={title} className="corner-cut" style={{ padding: 25, background: "rgba(57,255,20,0.03)", border: "1px solid rgba(57,255,20,0.1)", textAlign: "center" }}>
          ...
          <div className="container">
            ...
            <div className="tokenomics-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 25 }}>
              {[
                ...
                <div key={i} className="corner-cut" style={{ background: "var(--bg-card)", padding: 35, border: "1px solid rgba(57,255,20,0.2)" }}>
        ...
        <section id="roadmap" style={{ background: "var(--bg-panel)" }}>
          <div className="container">
            ...
            <div style={{ borderLeft: "2px solid var(--neon-green)", paddingLeft: 40, marginLeft: 10 }}>
              {[
